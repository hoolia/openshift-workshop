...
Return to the link:{{console_url}}/topology/ns/{{ username }}[Web Console] +++<span class="fas fa-window-restore"></span>+++.
...
[source,role=copy]
----
registry.chp.belastingdienst.nl/learn/{{PARKSMAP_IMAGENAME}}:{{PARKSMAP_VERSION}}
----

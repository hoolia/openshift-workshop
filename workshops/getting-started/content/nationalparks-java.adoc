...
The repository that we are going to use should be forked from wolfj09 into to your own personal project:

fork from:

link:https://devtools.belastingdienst.nl/bitbucket/users/{{username}}/repos/nationalparks.git[wolfj09 BitBucket Repository]

into:

link:https://devtools.belastingdienst.nl/bitbucket/users/{{username}}/repos/nationalparks.git[{{username}} BitBucket Repository]
